...
test(
    '--version option', async t => {
    const result = await execa(
        '../markdownlint.js', [ '--version' ],
...
test(
    'no files shows help', async t => {
    const result =
      await execa('../markdownlint.js', [], {stripFinalNewline : false});
    t.true(result.stdout.includes('--help'));
    t.is(result.stderr, '');
    }
);
...
test(
    'files and --stdin shows help', async t => {
    const result = await execa(
        '../markdownlint.js', [ '--stdin', 'correct.md' ],
        {stripFinalNewline : false}
    );
    t.true(result.stdout.includes('--help'));
    t.is(result.stderr, '');
...
test(
    '--fix and --stdin shows help', async t => {
    const result =
    await execa(
        '../markdownlint.js', [ '--fix', '--stdin', 'correct.md' ],
        {stripFinalNewline : false}
    );
    t.true(result.stdout.includes('--help'));
    t.is(result.stderr, '');
...
test(
    'linting of correct Markdown file yields no output', async t => {
    const result = await execa(
        '../markdownlint.js',
...
test(
    'linting of correct Markdown file yields no output with absolute path',
    async t => {
    const result = await execa(
        '../markdownlint.js',
...
test(
    'linting of incorrect Markdown file fails', async t => {
    try {
    await execa(
        '../markdownlint.js',
...
test(
    'linting of incorrect Markdown file fails with absolute path', async t => {
    try {
    await execa(
        '../markdownlint.js',
...
test(
    'linting of incorrect Markdown via npm run file fails with eol',
    async t => {
    try {
...
test(
    'glob linting works with passing files', async t => {
    const result = await execa(
        '../markdownlint.js', [ '--config', 'test-config.json', '**/correct.md' ],
        {stripFinalNewline : false}
    );
    t.is(result.stdout, '');
    t.is(result.stderr, '');
...
test(
    'glob linting works with failing files', async t => {
    try {
    await execa(
        '../markdownlint.js',
...
test(
    'dir linting works with passing .markdown files', async t => {
    const result =
    await execa(
        '../markdownlint.js',
...
test(
    'dir linting works with failing .markdown files', async t => {
    try {
    await execa(
        '../markdownlint.js',
...
test(
    'dir linting works with failing .markdown files and absolute path',
    async t => {
    try {
    await execa(
        '../markdownlint.js',
...
test(
    'glob linting with failing files passes when failures ignored by glob',
    async t => {
    const result = await execa(
        '../markdownlint.js',
        [
...
test(
    'glob linting with failing files passes when everything ignored by glob',
    async t => {
    const result = await execa(
        '../markdownlint.js',
...
test(
    'glob linting with failing files has fewer errors when ignored by dir',
    async t => {
    try {
    await execa(
        '../markdownlint.js',
...
test(
    'glob linting with failing files has fewer errors when ignored by dir and absolute path',
    async t => {
    try {
    await execa(
        '../markdownlint.js',
...
test(
    'dir linting with failing files has fewer errors when ignored by file',
    async t => {
    try {
    await execa(
        '../markdownlint.js',
        [
                    '--config', 'test-config.json', 'subdir-incorrect',
                    '--ignore', 'subdir-incorrect/incorrect.md'
                  ],
        {stripFinalNewline : false}
    );
      t.fail();
...
test(
    'dir linting with failing files has fewer errors when ignored by file and absolute path',
    async t => {
    try {
    await execa(
        '../markdownlint.js',
        [
                    ...
                    path.resolve('subdir-incorrect'), '--ignore',
...
test(
    'glob linting with failing files passes when ignored by multiple globs',
    async t => {
    const result =
        await execa(
            '../markdownlint.js',
...
test(
    'linting results are sorted by file/line/names/description', async t => {
    try {
    await execa(
        '../markdownlint.js',
        [ '--config', 'test-config.json', 'incorrect.md' ],
...
test(
    'glob linting does not try to lint directories as files', async t => {
    try {
    await execa(
        '../markdownlint.js',
...
test(
    '--stdin with empty input has no output', async t => {
    const input = '';
    const result = await execa(
        '../markdownlint.js', [ '--stdin' ],
...
test(
    '--stdin with valid input has no output', async t => {
...
test(
    '--stdin with invalid input reports violations', async t => {
    const input = [ 'Heading', '', 'Text ', '' ].join('\n');
    try {
    await execa(
        '../markdownlint.js', [ '--stdin' ],
...
test(
    'stdin support does not interfere with file linting', async t => {
    const result =
    await execa(
        '../markdownlint.js',
...
test(
    '--output with empty input has empty output', async t => {
    const input = '';
    const output = '../outputA.txt';
    const result =
    await execa(
        '../markdownlint.js', [ '--stdin', '--output', output ],
        {input, stripFinalNewline : false}
    );
    t.is(result.stdout, '');
    t.is(result.stderr, '');
...
test(
    '--output with valid input has empty output', async t => {
    const input = [ '# Heading', '', 'Text', '' ].join('\n');
...
test(
    '--output with invalid input outputs violations', async t => {
    const input = [ 'Heading', '', 'Text ', '' ].join('\n');
...
test(
    '--output with invalid path fails', async t => {
    const input = '';
...
test(
    'configuration file can be YAML', async t => {
    const result =
    await execa(
        '../markdownlint.js',
...
test(
    'configuration file can be JavaScript', async t => {
    const result =
    await execa(
        '../markdownlint.js',
...
test(
    'Custom rule from single file loaded', async t => {
    try {
      const input = '# Input\n';
    await execa(
        '../markdownlint.js',
...
test(
    'Multiple custom rules from single file loaded', async t => {
    try {
      const input = '# Input\n';
    await execa(
        '../markdownlint.js',
...
test(
    'Custom rules from directory loaded', async t => {
    try {
      const input = '# Input\n';
    await execa(
        '../markdownlint.js',
...
test(
    'Custom rules from glob loaded', async t => {
    try {
      const input = '# Input\n';
    await execa(
        '../markdownlint.js',
...
test(
    'Custom rule from node_modules package loaded', async t => {
    try {
      const input = '# Input\n';
    await execa(
        '../markdownlint.js',
    ...
    const expected =
        [ 'stdin:1 test-rule-package Test rule package broken', '' ].join('\n');
    t.is(error.stdout, '');
    t.is(error.stderr, expected);
    }
    }
...
test(
    'Custom rule from node_modules package loaded relative to cwd',
    async t => {
    try {
      const input = '# Input\n';
    await execa(
...
test(
    'Custom rule from package loaded', async t => {
    try {
      const input = '# Input\n';
    await execa(
        '../markdownlint.js',
...
test(
    'Custom rule from several packages loaded', async t => {
    try {
      const input = '# Input\n';
    await execa(
        '../markdownlint.js',
        [
                    '--rules', './custom-rules/test-rule-package', '--rules',
                    './custom-rules/test-rule-package-other', '--stdin'
                  ],
        {input, stripFinalNewline : false}
    );
      t.fail();
...
test(
    'Invalid custom rule name reports error', async t => {
    try {
      const input = '# Input\n';
    await execa(
        '../markdownlint.js',
        [
                    '--rules', 'test-rule-package', '--rules', 'invalid-package',
                    '--stdin'
                  ],
        {input, stripFinalNewline : false}
    );
    ...
    const expected =
        [ 'Cannot load custom rule invalid-package: No such rule', '' ].join(
            '\n'
        );
    t.is(error.stdout, '');
    t.is(error.stderr, expected);
...
test(
    'fixing errors in a file yields fewer errors', async t => {
    ...
    const expected = [
      ...
      fixFileA +
          ':1 MD041/first-line-heading/first-line-h1 First line in file should be a top level heading [Context: "## header 2"]',
      ''
    ].join('\n');
    t.is(error.stdout, '');
    t.is(error.stderr, expected);
...
test(
    'fixing errors in a file with absolute path yields fewer errors',
    async t => {
...
test(
    'fixing errors with a glob yields fewer errors', async t => {
...
test(
    '.markdownlintignore is applied correctly', async t => {
    try {
    await execa(
        path.resolve('..', 'markdownlint.js'), [ '.' ], {
...
test(
    '.markdownlintignore works with semi-absolute paths', async t => {
    try {
    await execa(
...
test(
    '--ignore-path works with .markdownlintignore', async t => {
    try {
    await execa(
        path.resolve('..', 'markdownlint.js'),
...
test(
    '--ignore-path works with .ignorefile', async t => {
    try {
    await execa(
        path.resolve('..', 'markdownlint.js'),
...
test(
    '--ignore-path fails for missing file', async t => {
